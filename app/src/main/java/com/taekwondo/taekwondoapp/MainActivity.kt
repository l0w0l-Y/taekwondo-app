...
import com.taekwondo.featureevent.presentation.tournament.TournamentScreen
                        ...
                        Scaffold {
                            NavHost(
                                ...
                                composable(
                                    ...
                                    EventScreen(
                                        navController = navController,
                                        backStackEntry.arguments?.getLong("uid")
                                    )
                                }
                                composable(
                                ...
                                composable(
                                    JudgingDirection.path + "?eventId={eventId}&fightId={fightId}",
                                    arguments = listOf(
                                        navArgument("eventId") { type = NavType.LongType },
                                        navArgument("fightId") { type = NavType.LongType },
                                    )
                                ) {
                                    JudgingScreen(navController = navController)
                                }
                                composable(
                                    TournamentDirection.path + "?eventId={eventId}",
                                    arguments = listOf(
                                        navArgument("eventId") { type = NavType.LongType },
                                    )
                                ) {
